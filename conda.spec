...
Version  : 4.7.10
Release  : 26
URL      : https://github.com/conda/conda/archive/4.7.10/conda-4.7.10.tar.gz
Source0  : https://github.com/conda/conda/archive/4.7.10/conda-4.7.10.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563638098
