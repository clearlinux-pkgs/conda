...
Version  : 4.7.11
Release  : 27
URL      : https://github.com/conda/conda/archive/4.7.11/conda-4.7.11.tar.gz
Source0  : https://github.com/conda/conda/archive/4.7.11/conda-4.7.11.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565139954
