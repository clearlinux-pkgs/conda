...
Version  : 4.7.7
Release  : 24
URL      : https://github.com/conda/conda/archive/4.7.7/conda-4.7.7.tar.gz
Source0  : https://github.com/conda/conda/archive/4.7.7/conda-4.7.7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563034690
