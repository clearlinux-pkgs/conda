...
Version  : 4.7.0
Release  : 13
URL      : https://github.com/conda/conda/archive/4.7.0/conda-4.7.0.tar.gz
Source0  : https://github.com/conda/conda/archive/4.7.0/conda-4.7.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1558194305
export AR=gcc-ar
